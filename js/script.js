...
var createNewTaskElement=function(taskString){
    ...
    //creating a clads in html called delete class="delete"
    deleteButton.className="delete";

    //and appending
    // which allows the element we create to appear on you web page or app
...
var addTask=function(){
    ...
    //Createa newe list item with the text from the #new-task:
    var listItem=createNewTaskElement (taskInput.value);

    // Applied listItem to incompleteTaskHolder
